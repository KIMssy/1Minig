...
a<-sum(diag(t))/sum(t)
nn_iris2<-nnet(Species~.,data = iris, size=2, rang =0.1, decay =0, maxit =200)
nn_iris5<-nnet(Species~.,data = iris, size=5, rang =0.1, decay =0, maxit =200)
nn_iris10<-nnet(Species~.,data = iris, size=10, rang =0.1, decay =0, maxit =200)
plot.nnet(nn_iris2)
plot.nnet(nn_iris5)
plot.nnet(nn_iris10)
